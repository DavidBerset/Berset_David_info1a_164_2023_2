        ...
        try:
            with DBconnection() as mc_afficher:
                if order_by == "ASC" and id_genre_sel == 0:
                    ...
                    strsql_genres_afficher = """SELECT id_fournisseur, nom_fournisseur FROM t_fournisseur WHERE id_fournisseur = %(value_id_genre_selected)s"""
    ...
    if request.method == "POST":
        try:
            if form.validate_on_submit():
                ...
                strsql_insert_genre = """INSERT INTO t_fournisseur (id_fournisseur,nom_fournisseur,) VALUES (NULL,%(value_intitule_genre)s) """
...
def genre_update_wtf():
    ...
    try:
        if form_update.validate_on_submit():
            ...
            str_sql_update_intitulegenre = """UPDATE t_fournisseur 
                                              SET nom_fournisseur = %(value_name_genre)s
                                              WHERE id_fournisseur = %(value_id_genre)s"""
            str_sql_update_intitulegenre = """UPDATE t_mail 
                                                          SET nom_mail = %(value_nom_mail)s
            ...
            str_sql_id_genre = "SELECT id_fournisseur, nom_fournisseur FROM t_fournisseur WHERE id_fournisseur = %(value_id_genre)s"
            ...
            form_update.nom_genre_update_wtf.data = data_nom_genre["nom_fournisseur"]

    except Exception as Exception_genre_update_wtf:
        raise ExceptionGenreUpdateWtf(
            f"fichier : {Path(__file__).name}  ;  {genre_update_wtf.__name__} ; {Exception_genre_update_wtf}")
    ...
    try:
        ...
        if request.method == "POST" and form_delete.validate_on_submit():
            ...
            if form_delete.submit_btn_del.data:
                ...
                str_sql_delete_films_genre = """DELETE FROM t_boisson_acheter_fournisseur WHERE fk_fournisseur = %(value_id_genre)s"""
                str_sql_delete_idgenre = """DELETE FROM t_fournisseur WHERE id_fournisseur = %(value_id_genre)s"""
        ...
        if request.method == "GET":
            ...
            str_sql_genres_films_delete = """SELECT id_boisson_acheter_fournisseur, nom_boisson, id_fournisseur, nom_fournisseur FROM t_boisson_acheter_fournisseur 
                                            ...
                                            WHERE fk_fournisseur = %(value_id_genre)s"""
            ...
            with DBconnection() as mydb_conn:
                ...
                print("data_nom_genre ", data_nom_genre, " type ", type(data_nom_genre), " genre ",
                      data_nom_genre["nom_fournisseur"])

            # Afficher la valeur sélectionnée dans le champ du formulaire "genre_delete_wtf.html"
            form_delete.nom_genre_delete_wtf.data = data_nom_genre["nom_fournisseur"]
